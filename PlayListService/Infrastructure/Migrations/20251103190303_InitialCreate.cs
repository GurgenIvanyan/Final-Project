    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SongMetadataId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    SongId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SongMetadata", x => x.SongMetadataId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlaylistSongVotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlaylistSongVotes_PlaylistSongs_PlaylistId_SongId",
                        columns: x => new { x.PlaylistId, x.SongId },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "D3AD9315B7BE5DD53B31A273B3B3ABA5DEFE700808305AA16A3062B76658A791", "Admin", "demo" });
